...
#define NEO_RGB_TYPE                0            // Neopixel RGB leds
#define NEO_GRB_TYPE                1            // Neopixel GRB leds
#define NEO_BRG_TYPE                2            // Neopixel BRG leds
#define NEO_RBG_TYPE                3            // Neopixel RBG leds
#define NEO_3LED_TYPE               4            // Placeholder to test for 4 led types
#define NEO_RGBW_TYPE               5            // Neopixel RGBW leds
#define NEO_GRBW_TYPE               6            // Neopixel GRBW leds
